...
- Postgresql 
#### Github
- Enter this url: [https://github.com/sam2if/BLOGAPP](https://github.com/sam2if/BLOGAPP) in your web browser.
...
- After cloning type `cd blogapp` to access the project on the terminal.
